<script lang="ts">
  ...
  import { getInitials, colorHexMap, formatRelativeTime, calculateProgress, type ChildColor } from '$lib/utils';
...
<div class="space-y-6">
  ...
  <div class="flex items-center justify-between">
    <div class="flex items-center gap-4">
      ...
      {:else}
        <div
          class="flex h-16 w-16 items-center justify-center rounded-full text-2xl font-bold text-white bg-child-{data.child.color}"
        >
  ...
  {#if data.balanceHistory.length > 0}
    <div class="card p-6">
      ...
      <div class="h-48">
        <LineChart data={data.balanceHistory} color={colorHex} currency={data.settings?.currency ?? 'EUR'} />
      </div>
    </div>
  {/if}
      ...
      <div class="relative w-full max-w-md rounded-xl bg-white p-6 shadow-xl">
        ...
        >
          ...
          <div class="flex justify-end gap-3 pt-4">
            <button type="button" class="btn-secondary" onclick={() => (showAddMoney = false)}>Cancel</button>
    ...
    <div class="flex min-h-full items-center justify-center p-4">
      ...
      <div class="relative w-full max-w-md rounded-xl bg-white p-6 shadow-xl">
        ...
        >
          ...
          <div class="flex justify-end gap-3 pt-4">
            <button type="button" class="btn-secondary" onclick={() => (showWithdraw = false)}>Cancel</button>

...
<div class="flex min-h-screen flex-col items-center justify-center bg-gray-900 p-4">
  <div class="w-full max-w-sm">
    <div class="text-center mb-8">
      ...
      <p class="mt-2 text-gray-400">Enter your PIN to continue</p>
    </div>
    ...
    <form method="POST" action="/login?/logout" class="mt-6">
      <button type="submit" class="w-full text-center text-sm text-gray-500 hover:text-gray-400">
        Sign out
      </button>
    </form>
  </div>
